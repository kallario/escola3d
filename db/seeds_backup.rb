...
{ "grupo_id": 7, "id": 181, "titulo_pergunta": "ele(a) tenha prazer em ajudar em uma tarefa relacionada com detalhes de organização." },
{ "grupo_id": 7, "id": 182, "titulo_pergunta": "ele(a) teria prazer em viver a maior parte da sua vida em um país ou cultura diferente." },
{ "grupo_id": 7, "id": 183, "titulo_pergunta": "ele(a) teria menos dificuldades de permanecer solteiro(a) do que outra pessoa." },
{ "grupo_id": 7, "id": 184, "titulo_pergunta": "ele(a) conheça, melhor do que outros, as motivações que estão por trás de um determinado comportamento." },
{ "grupo_id": 7, "id": 185, "titulo_pergunta": "o chamado específico é falar com não cristãos sobre a fé em Jesus Cristo." },
{ "grupo_id": 7, "id": 186, "titulo_pergunta": "pessoas o(a) procurem para receber aconselhamento." },
{ "grupo_id": 7, "id": 187, "titulo_pergunta": "ele(a) esteja disposto(a) a correr grandes riscos pessoais para alcançar os seus objetivos." },
{ "grupo_id": 7, "id": 188, "titulo_pergunta": "para ele(a) é mais importante do que para a maioria dos cristãos, apoiar financeiramente projetos cristãos." },
{ "grupo_id": 7, "id": 189, "titulo_pergunta": "ele(a) saiba discernir, melhor do que outras pessoas, se algo é de origem humana, satânica ou divina." },
{ "grupo_id": 7, "id": 190, "titulo_pergunta": "pessoas o(a) procurem mais do que a outras pessoas para que ore por sua cura." },
{ "grupo_id": 7, "id": 191, "titulo_pergunta": "ele(a) tenha alegria imensa em ensinar outros cristãos." },
{ "grupo_id": 7, "id": 192, "titulo_pergunta": "ele(a) tenha o dom de orar em línguas." },
{ "grupo_id": 7, "id": 193, "titulo_pergunta": "seja mais fácil para ele(a) resolver problemas complicados de outras pessoas." },
{ "grupo_id": 7, "id": 194, "titulo_pergunta": "ele(a) seja mais feliz com poucos bens materiais do que com muitos." },
{ "grupo_id": 7, "id": 195, "titulo_pergunta": "as suas mãos sejam mais habilidosas do que as da maioria das pessoas." },
{ "grupo_id": 7, "id": 196, "titulo_pergunta": "ele(a) tenha prazer em ajudar outras pessoas com tarefas que tomem um tempo considerável." },
{ "grupo_id": 7, "id": 197, "titulo_pergunta": "ele(a) seja mais feliz com visitas em casa do que sem." },
{ "grupo_id": 7, "id": 198, "titulo_pergunta": "ele(a) sinta mais alegria do que a maioria dos cristãos ao investir muito tempo em oração." },
{ "grupo_id": 7, "id": 199, "titulo_pergunta": "ele(a) esteja em condições de interpretar a oração em línguas de outro cristão." },
{ "grupo_id": 7, "id": 200, "titulo_pergunta": "ele(a) tenha prazer em investir muito tempo no desenvolvimento de novas idéias." },
{ "grupo_id": 7, "id": 201, "titulo_pergunta": "o chamado dele(a) seja dar a outros orientações para a sua caminhada." },
{ "grupo_id": 7, "id": 202, "titulo_pergunta": "ele(a) tenha mais facilidade de passar por sofrimentos do que outros cristãos." },
{ "grupo_id": 7, "id": 203, "titulo_pergunta": "seja a sua tarefa específica prestar ajuda prática a pessoas em necessidade." },
{ "grupo_id": 7, "id": 204, "titulo_pergunta": "Deus o(a) use frequentemente na realização de sinais e milagres." },
{ "grupo_id": 7, "id": 205, "titulo_pergunta": "ele(a) seja chamado(a) a dar conselhos na hora de instruir mais pessoas na liderança da igreja." },
{ "grupo_id": 7, "id": 206, "titulo_pergunta": "que ele(a) tenha muita alegria em acompanhar um grupo de cristãos por um período longo." },
{ "grupo_id": 7, "id": 207, "titulo_pergunta": "ele(a) seja mais usado(a) por Deus do que outros cristãos para transmitir mensagens à igreja." },
{ "grupo_id": 7, "id": 208, "titulo_pergunta": "seja mais fácil para ele(a) do que para outros, fazer um trabalho na igreja que é urgente no momento." },
{ "grupo_id": 7, "id": 209, "titulo_pergunta": "seja o seu chamado específico servir a Deus na área da música." },
{ "grupo_id": 7, "id": 210, "titulo_pergunta": "lhe dê prazer especial engajar-se no campo das artes (pintar, escrever, fazer teatro, etc.)." }
])
